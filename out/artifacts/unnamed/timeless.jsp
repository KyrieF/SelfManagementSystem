    ...
    <div class="row">
        <div class="col-lg-12">
            <header class="text-center tm-site-header">
                ...
                <h1 class="pl-4 tm-site-title">My Footstep</h1>
            </header>
        </div>
    </div>
    <div class="row">
...
<div class="container tm-container-2">
    <div class="row">
        <div class="col-lg-12">
            <p class="tm-text-orange tm-font-400"><a href="write.jsp">Write blog</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="menu.jsp">Back to menu</a></p>
        </div>
    </div>
    <div class="row tm-section-mb">
        <div class="col-lg-12">

            <c:forEach items="${sessionScope.footsteps}" var="m">
                    ...
                    <div class="tm-timeline-item-inner">
                        ...
                        <div class="tm-timeline-description-wrap">
                            <div class="tm-bg-dark-light tm-timeline-description">
                                <h3 class="tm-text-orange tm-font-400">${m.title}</h3>
                                <p>${m.paragragh}</p>
                                <p class="tm-text-orange float-right mb-0">${m.time}</p>
                                <a href="DeleteFootstepServlet?time=${m.time}">Delete</a>
                            </div>
                        </div>
                    </div>
