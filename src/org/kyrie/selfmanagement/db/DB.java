package org.kyrie.selfmanagement.db;
...
public class DB {
    ...
    public DB() {
        try {
            ...
            String url = "jdbc:mysql://127.0.0.1:3307/selfmanagement?serverTimezone=GMT%2B8&useSSL=false&allowPublicKeyRetrieval=true";
