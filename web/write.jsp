...
<div class="container">
    <div class="row tm-register-row tm-mb-35">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-l">
            <form action="AddFootstepServlet" method="post" class="tm-bg-black p-5 h-100">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-r">
            <header class="font-weight-light tm-bg-white p-5 h-100">
                ...
                <p style="color:white">Dear.${sessionScope.loginUser.nickname},welcome to use Kyrie's first webapp,please have fun and record your happy life!</p>
            </header>
        </div>
    </div>
</div>
